...
│   ├── areas/<area-slug>.md               # one per product area (web app: one menu): business rules P1… · numbers N1… (optional) · how it works · history
